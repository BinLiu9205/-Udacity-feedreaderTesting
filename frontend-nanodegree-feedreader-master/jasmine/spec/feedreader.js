...
$(function() {
    ...
    */
	...
	describe('Initial Entries', function(){
		...
		it('at least one a single .entry element within the .feed container',function(done){
			let elementSel =($('.feed .entry'));
			expect(elementSel.length).not.toBe(0);
			done();
		});
	});
	...
	describe('New Feed Selection', function(){
        ...
        */
		...
		it('the content of the feed changes after new post',function(){
